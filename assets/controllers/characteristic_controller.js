...
/*
 * This Controller manage rows in characteristics form
...
export default class extends Controller {
    ...
    connect() {
        console.log('characteristics works !')
    ...
    add(event){
        ...
        let wrapper = document.getElementsByClassName('js-characteristic-wrapper')[0]
